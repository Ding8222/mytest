...
#ifndef PROTOBUF_DBServer_2eproto_INCLUDED
#define PROTOBUF_DBServer_2eproto_INCLUDED
...
namespace google {
namespace protobuf {
template<> ::SvrData::Execute* Arena::Create< ::SvrData::Execute>(Arena*);
template<> ::SvrData::ExecuteRet* Arena::Create< ::SvrData::ExecuteRet>(Arena*);
}  // namespace protobuf
}  // namespace google
namespace SvrData {
...
class Execute : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SvrData.Execute) */ {
 public:
  ...
  inline Execute* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Execute>(NULL);
  }

  Execute* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<Execute>(arena);
  }
...
class ExecuteRet : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SvrData.ExecuteRet) */ {
 public:
  ...
  inline ExecuteRet* New() const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<ExecuteRet>(NULL);
  }

  ExecuteRet* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL {
    return ::google::protobuf::Arena::Create<ExecuteRet>(arena);
  }
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  ...
  const ::std::string& res(int index) const;
  ::std::string* mutable_res(int index);
  void set_res(int index, const ::std::string& value);
  #if LANG_CXX11
  void set_res(int index, ::std::string&& value);
  #endif
  void set_res(int index, const char* value);
  void set_res(int index, const char* value, size_t size);
  ::std::string* add_res();
  void add_res(const ::std::string& value);
  #if LANG_CXX11
  void add_res(::std::string&& value);
  #endif
  void add_res(const char* value);
  void add_res(const char* value, size_t size);
  const ::google::protobuf::RepeatedPtrField< ::std::string>& res() const;
  ::google::protobuf::RepeatedPtrField< ::std::string>* mutable_res();

  // @@protoc_insertion_point(class_scope:SvrData.ExecuteRet)
 private:

  ::google::protobuf::internal::InternalMetadataWithArena _internal_metadata_;
  ::google::protobuf::RepeatedPtrField< ::std::string> res_;
  mutable int _cached_size_;
  friend struct ::protobuf_DBServer_2eproto::TableStruct;
...
// repeated string res = 1;
inline int ExecuteRet::res_size() const {
  return res_.size();
}
inline void ExecuteRet::clear_res() {
  res_.Clear();
}
inline const ::std::string& ExecuteRet::res(int index) const {
  // @@protoc_insertion_point(field_get:SvrData.ExecuteRet.res)
  return res_.Get(index);
}
inline ::std::string* ExecuteRet::mutable_res(int index) {
  // @@protoc_insertion_point(field_mutable:SvrData.ExecuteRet.res)
  return res_.Mutable(index);
}
inline void ExecuteRet::set_res(int index, const ::std::string& value) {
  // @@protoc_insertion_point(field_set:SvrData.ExecuteRet.res)
  res_.Mutable(index)->assign(value);
}
#if LANG_CXX11
inline void ExecuteRet::set_res(int index, ::std::string&& value) {
  // @@protoc_insertion_point(field_set:SvrData.ExecuteRet.res)
  res_.Mutable(index)->assign(std::move(value));
}
#endif
inline void ExecuteRet::set_res(int index, const char* value) {
  GOOGLE_DCHECK(value != NULL);
  res_.Mutable(index)->assign(value);
  // @@protoc_insertion_point(field_set_char:SvrData.ExecuteRet.res)
}
inline void ExecuteRet::set_res(int index, const char* value, size_t size) {
  res_.Mutable(index)->assign(
    reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:SvrData.ExecuteRet.res)
}
inline ::std::string* ExecuteRet::add_res() {
  // @@protoc_insertion_point(field_add_mutable:SvrData.ExecuteRet.res)
  return res_.Add();
}
inline void ExecuteRet::add_res(const ::std::string& value) {
  res_.Add()->assign(value);
  // @@protoc_insertion_point(field_add:SvrData.ExecuteRet.res)
}
#if LANG_CXX11
inline void ExecuteRet::add_res(::std::string&& value) {
  res_.Add(std::move(value));
  // @@protoc_insertion_point(field_add:SvrData.ExecuteRet.res)
}
#endif
inline void ExecuteRet::add_res(const char* value) {
  GOOGLE_DCHECK(value != NULL);
  res_.Add()->assign(value);
  // @@protoc_insertion_point(field_add_char:SvrData.ExecuteRet.res)
}
inline void ExecuteRet::add_res(const char* value, size_t size) {
  res_.Add()->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_add_pointer:SvrData.ExecuteRet.res)
}
inline const ::google::protobuf::RepeatedPtrField< ::std::string>&
ExecuteRet::res() const {
  // @@protoc_insertion_point(field_list:SvrData.ExecuteRet.res)
  return res_;
}
inline ::google::protobuf::RepeatedPtrField< ::std::string>*
ExecuteRet::mutable_res() {
  // @@protoc_insertion_point(field_mutable_list:SvrData.ExecuteRet.res)
  return &res_;
}
...
#endif  // PROTOBUF_DBServer_2eproto_INCLUDED
